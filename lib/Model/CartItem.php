...
class CartItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['out_of_stock'] = $data['out_of_stock'] ?? null;
     ...
     * Sets discount
     *
     * @param int $discount Non-negative discount for the given item. Can be used by the shipping rule engine to calculate the best shipping option.
     *
     * @return self
     */
     ...
     * Sets image_url
     *
     * @param string|null $image_url URL of the image of the given cart item.
     *
     * @return self
     */
     ...
     * Sets out_of_stock
     *
     * @param bool|null $out_of_stock Flag indicating if the item is currently out of stock.
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param int $price Non-negative price of the item after the discount applied. Can be used by the shipping rule engine to calculate the best shipping option.
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param int $quantity Total number of the product item in the cart.
     *
     * @return self
     */
     ...
     *
     * @param string|null $site_external_id Site external ID can be used in case of marketplace configuration. If sent empty, top level site will be used.
     *
     * @return self
     */
